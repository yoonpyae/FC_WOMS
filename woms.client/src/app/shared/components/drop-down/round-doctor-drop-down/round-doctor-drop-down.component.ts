...
@Component({
  selector: 'app-round-doctor-drop-down',
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => RoundDoctorDropDownComponent),
      multi: true
    }
  ],
})
export class RoundDoctorDropDownComponent {
  ...
  public loadData(): void {
    ...
    this.loading = true;
    this.doctorService.getRound(hospitalId).subscribe({
      next: (res) => {
